...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"345989a7-2f8c-414e-9709-f5e8903d5a00\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.companyname.espcommapp\00", align 16
...
@__DSOCacheEntry_name.5 = internal constant [25 x i8] c"libtensorflowlite_jni.so\00", align 16
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 9
	%struct.DSOCacheEntry {
