...
@dso_cache = local_unnamed_addr global [24 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 1093876316, ; hash 0x41333a5c, from name: tensorflowlite_jni.so
		i8 0, ; ignore
	...
	; 5
	%struct.DSOCacheEntry {
		i64 1117789669, ; hash 0x42a01de5, from name: libtensorflowlite_jni
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 13
	%struct.DSOCacheEntry {
		i64 2852651177, ; hash 0xaa0800a9, from name: tensorflowlite_jni
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 23
	%struct.DSOCacheEntry {
		i64 4104040453, ; hash 0xf49eb005, from name: libtensorflowlite_jni.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}
