...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"5b44207d-6b2f-4ae4-a802-266da0014e82\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.companyname.espcommapp\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555440, ; android_runtime_jnienv_class_token
	i32 100674973, ; jnienv_initialize_method_token
	i32 100674972, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.3 = internal constant [25 x i8] c"libtensorflowlite_jni.so\00", align 1
...
@dso_cache = local_unnamed_addr global [24 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 7082737077298140890, ; hash 0x624aefd889d816da, from name: tensorflowlite_jni
		i8 0, ; ignore
	...
	; 5
	%struct.DSOCacheEntry {
		i64 7094462407857024328, ; hash 0x627497f8ccae2d48, from name: libtensorflowlite_jni.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 14
	%struct.DSOCacheEntry {
		i64 11050331899391149503, ; hash 0x995aaa50b96085bf, from name: libtensorflowlite_jni
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 18
	%struct.DSOCacheEntry {
		i64 13689629905060776525, ; hash 0xbdfb55de2db64a4d, from name: tensorflowlite_jni.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
